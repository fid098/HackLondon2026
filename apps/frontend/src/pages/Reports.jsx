  ...
  return (
    <div className="relative max-w-4xl mx-auto px-5 py-14">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden>
        <div className="absolute rounded-full blur-3xl" style={{ width: 500, height: 500, top: '-12%', right: '-12%', background: 'radial-gradient(circle, rgba(239,68,68,0.2), transparent 70%)' }} />
        <div className="absolute blur-3xl" style={{ width: 380, height: 260, bottom: '0', left: '-10%', borderRadius: '60% 40% 30% 70% / 60% 30% 70% 40%', background: 'radial-gradient(circle, rgba(185,28,28,0.18), transparent 70%)' }} />
        <div className="absolute blur-2xl" style={{ width: 300, height: 180, top: '45%', left: '30%', borderRadius: '40% 60%', background: 'radial-gradient(circle, rgba(239,68,68,0.1), transparent 70%)' }} />
        <div className="absolute rounded-full blur-3xl" style={{ width: 220, height: 220, top: '20%', left: '-5%', background: 'radial-gradient(circle, rgba(220,38,38,0.12), transparent 70%)' }} />
      </div>
